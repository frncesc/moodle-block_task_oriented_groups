...
$string['privacy:metadata:btog_intelligences_answers:userid'] = 'La identificació de l\'usuari que respon a la pregunta.';
$string['privacy:metadata:btog_intelligences_answers:question'] = 'L\'identificador de la pregunta.';
$string['privacy:metadata:btog_intelligences_answers:answer'] = 'L\'identificador de la resposta a la pregunta.';
$string['privacy:export:btog_intelligences_answers'] = 'Prova d\'intel·ligències';

$string['privacy:metadata:btog_personality'] = 'Informació sobre la personalitat d\'un usuari.';
$string['privacy:metadata:btog_personality:userid'] = 'La identificació de l\'usuari que la personalitat fa referència.';
$string['privacy:metadata:btog_personality:type'] = 'El tipus de personalitat.';
$string['privacy:metadata:btog_personality:gender'] = 'El sexe de l\'usuari.';
$string['privacy:metadata:btog_personality:judgment'] = 'El valor de la personalitat del judici de l\'usuari.';
$string['privacy:metadata:btog_personality:attitude'] = 'Actitud personalitat de l\'usuari.';
$string['privacy:metadata:btog_personality:perception'] = 'La percepció del factor de personalitat de l\'usuari.';
$string['privacy:metadata:btog_personality:gender'] = 'El factor de personalitat extrovertida de l\'usuari.';
$string['privacy:export:btog_personality'] = 'Personalitat';

$string['privacy:metadata:btog_intelligences'] = 'Informació sobre les intel·ligències d\'un usuari.';
$string['privacy:metadata:btog_intelligences:userid'] = 'Identificador de l\'usuari que les intel·ligències refereixen.';
...
$string['privacy:metadata:btog_intelligences:naturalist_environmental'] = 'El factor d\'intel·ligència naturalista/mediambiental de l\'usuari.';
$string['privacy:export:btog_intelligences'] = 'Intel·ligències';
...
$string['externallib:group_description_intelligence_kinestesica_corporal'] = 'Intel·ligència corporal cinestèsica';
$string['externallib:group_description_intelligence_logic_mathematics'] = 'Intel·ligència lògica i matemàtica';
$string['externallib:group_description_intelligence_musical_rhythmic'] = 'Intel·ligència musical';
$string['externallib:group_description_intelligence_naturalist_environmental'] = 'Intel·ligència naturalista-mediambiental';
$string['externallib:group_description_intelligence_verbal'] = 'Intel·ligència lingüística';
$string['externallib:group_description_intelligence_visual_spatial'] = 'Intel·ligència visual-espacial';
